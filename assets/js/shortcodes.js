...
;(function($) {
    ...
    var googleMap = function () {
        // gmap default
        if ($().gmap3) {
            var data = JSON.parse('[{"address":"109A, đường 3/2, phường Tân An, TP. Cần Thơ","content":""}]');
            $(".themesflat-map")
                .gmap3({
                    map: {
                        options: {
                            zoom: 10,
                            center: [10.0455,105.7469,14.5],
                            mapTypeId: 'NguyenGiang',
                            mapTypeControlOptions: {
                                mapTypeIds: ['NguyenGiang', google.maps.MapTypeId.SATELLITE, google.maps.MapTypeId.HYBRID]
                            },
                            scrollwheel: true
                        },
                    },
